...
const submit = () => {
    form.post(route('balita.update', { balita: data.id }), {
        forceFormData: true,
    });
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Data Balita</h2>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui informasi balita di bawah ini.</CardDescription>
                    </CardHeader>
                        ...
                        <CardContent class="space-y-6">
                            <div class="flex justify-center mb-6">
                                <div class="relative h-24 w-24 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden border-2">
                                    <img v-if="data.foto && !form.foto" :src="data.foto" :alt="data.nama" class="h-full w-full object-cover" />
                                    <User v-else-if="!form.foto" class="h-12 w-12 text-gray-400" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                        :class="{ 'border-destructive': form.errors.nama_orang_tua }"
                                    />
