    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-bold tracking-tight text-gray-900">Tambah Bidan</h2>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <Card class="border-none shadow-sm bg-white">
                        ...
                        <CardContent class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-1.5">
                                ...
                                <Input v-model="form.nama_bidan" required :class="{ 'border-destructive': form.errors.nama_bidan }" />
                    ...
                    <div class="flex items-center justify-between pt-2 pb-6">
                        ...
                        <Button type="submit" :disabled="form.processing"
                            ...
                            <span class="font-semibold">{{ form.processing ? 'Menyimpan...' : 'Simpan Bidan' }}</span>
                        </Button>
                    </div>
                </form>
            </div>
