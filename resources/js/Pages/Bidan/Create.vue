    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Bidan</h2>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Hubungkan akun user dengan data profil bidan.</CardDescription>
                    </CardHeader>
                    <form @submit.prevent="submit">
                        <CardContent class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    <Label for="nama_bidan">Nama Lengkap (Display)</Label>
                                    <Input
                                        id="nama_bidan"
