...
const submit = () => {
    form.post(route('jadwal-posyandu.store'), {
        onSuccess: () => {
            toast.success('Berhasil', 'Jadwal posyandu berhasil dibuat.');
        },
        onError: () => {
            toast.error('Gagal', 'Terjadi kesalahan saat menyimpan jadwal.');
        },
    });
};
</script>
            ...
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription
                            >Tentukan waktu dan lokasi kegiatan Posyandu
                            berikutnya.</CardDescription
                        >
                    </CardHeader>
                        ...
                        <CardContent class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    :class="{
                                        'border-destructive':
                                            form.errors.catatan_bidan,
                                    }"
                                />
                                <p
                                    v-if="form.errors.catatan_bidan"
                                    class="text-sm text-destructive"
                                >
                                    {{ form.errors.catatan_bidan }}
                                </p>
