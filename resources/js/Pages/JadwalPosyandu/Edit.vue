...
import { ArrowLeft, CheckCircle, Loader, Loader2, Save, XCircle } from 'lucide-vue-next';
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit / Validasi Jadwal</h2>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Perbarui informasi atau validasi jadwal kegiataan.</CardDescription>
                    </CardHeader>
                    <form @submit.prevent="submit">
                        <CardContent class="space-y-6">
                            ...
                            <div class="space-y-4 border-t pt-4">
                                <h3 class="text-lg font-medium">Validasi Bidan</h3>
                                <div class="space-y-2">
                                    <Label for="bidan_id">Bidan Pemeriksa</Label>
                                    <Select v-model="form.bidan_id" :disabled="!isBidan && !isAdmin">
                                        <SelectTrigger>
                                            <SelectValue placeholder="Pilih Bidan" />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem v-for="b in bidan" :key="b.id" :value="b.id">
                                                {{ b.nama }}
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Select v-model="form.status" :disabled="!isBidan && !isAdmin">
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="validated">Divalidasi (Disetujui)</SelectItem>
                                ...
                                <div class="space-y-2">
                                    <Label for="catatan_bidan">Catatan Bidan / Alasan Penolakan</Label>
                                    <Textarea
                                        id="catatan_bidan"
                        ...
                        <CardFooter class="flex justify-between border-t px-6 py-4">
                            ...
                            <div class="flex gap-2">
                                <template v-if="isBidan || isAdmin">
                                    <Button variant="destructive" type="button" @click="validate('rejected')" :disabled="form.processing">
                                        Tolak
                                    </Button>
                                    <Button variant="default" type="button" class="bg-green-600 hover:bg-green-700" @click="validate('validated')" :disabled="form.processing">
                                        Setujui
                                    </Button>
                                </template>
