...
const form = useForm({
    ...
    tgl_lahir: '', jenis_kelamin: 'L', no_telp: '', alamat: '', keterangan: '',
});

const submit = () => {
    form.post(route('lansia.store'), {
        forceFormData: true,
        onSuccess: () => toast.success('Berhasil', 'Data lansia berhasil ditambahkan.'),
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-bold tracking-tight text-gray-900">Tambah Lansia</h2>
