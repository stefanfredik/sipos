...
onMounted(() => {
    ...
    console.log('Lansia prop:', props.lansia);
...
const submit = () => {
    form.post(route('lansia.update', { lansia: data?.id }), {
        forceFormData: true,
        onSuccess: () => {
            toast.success('Berhasil', 'Data lansia berhasil diperbarui.');
        },
        onError: () => {
            ...
            <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription
                            >Perbarui informasi lansia di bawah
                            ini.</CardDescription
                        >
                    </CardHeader>
