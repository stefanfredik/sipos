    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold">Laporan Ibu Hamil</h2>
                    ...
                    <TableBody>
                        <TableRow v-for="(item, i) in data" :key="item.id">
                            ...
                            <TableCell class="text-center">
                                <Badge variant="secondary" v-if="item.usia_kehamilan">{{ item.usia_kehamilan }} Minggu</Badge>
