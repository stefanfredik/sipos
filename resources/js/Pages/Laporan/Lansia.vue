...
function exportPdf() {
    ...
    type.type = 'hidden'; type.name = 'type'; type.value = 'lansia'
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold">Laporan Lansia</h2>
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow v-if="data.length === 0">
                            <TableCell colspan="5" class="h-24 text-center text-muted-foreground">Tidak ada data lansia</TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
            </Card>
