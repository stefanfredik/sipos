...
const currentParticipants = computed(() => {
    return props.participants[form.peserta_type as keyof typeof props.participants] || [];
});
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Data Pemeriksaan</h2>
            </div>
        </template>
                    ...
                    <Card>
                        ...
                        <CardContent class="grid gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2 opacity-50">
                                <Label for="peserta_type">Kategori Peserta (Tetap)</Label>
                                <Input :value="form.peserta_type.replace('_', ' ')" readonly />
                            </div>

                            <div class="space-y-2 opacity-50">
                                <Label for="peserta_id">Nama Peserta (Tetap)</Label>
                                <Input :value="data.peserta?.nama" readonly />
                            </div>
                        ...
                        <Card v-if="form.peserta_type === 'balita'">
                            ...
                            <CardContent class="grid gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="vitamin" v-model="form.vitamin" />
                                </div>
                                <div class="flex items-center space-x-2">
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Textarea id="edukasi" v-model="form.edukasi" />
                            </div>
                            <div class="space-y-2">
