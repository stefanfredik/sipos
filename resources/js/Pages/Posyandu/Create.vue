    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Posyandu</h2>
            </div>
        </template>
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Daftarkan unit posyandu baru di lingkungan Anda.</CardDescription>
                    </CardHeader>
