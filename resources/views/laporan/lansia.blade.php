...
<body>
    @include('laporan._header', ['judul' => 'Laporan Data Lansia'])
        ...
        <tbody>
            @forelse($data as $i => $item)
                <tr>
                    ...
                    <td class="text-center">
                        {{ $item->pemeriksaan->isNotEmpty() ? $item->pemeriksaan->first()->tensi_darah : '-' }}
                    </td>
                    <td class="text-center">
    ...
    <p class="summary">Total: {{ count($data) }} lansia</p>
</body>
</html>
